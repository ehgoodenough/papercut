...
var Hand = function(protomonster) {
...
Hand.prototype.getStyle = function() {
    return {
        width: this.size + "em",
        height: this.size + "em",
...
Hand.prototype.attackPlayer = function () {
    window.game.ninja.getAttacked()
}

Hand.prototype.die = function() {
    this.alive = false
}

Hand.prototype.getAttacked = function(source) {
    if (this.health > 1){
        this.health--
    }
    else {
